...
def firebase_login():
    """
    Legacy and Web adapter for verified Google Sign-In via Firebase Auth.
    Delegates directly to api_auth_google to enforce identical security rules,
    email verification, and zero auto-registration.
    """
    from app.api.routes import api_auth_google
    return api_auth_google()
